...
(let* (
        ...
        (laynew (gimp-layer-new img (car (gimp-image-width img)) (car (gimp-image-height img)) RGBA-IMAGE "name" 100 LAYER-MODE-NORMAL-LEGACY))
       )
...
(script-fu-menu-register "script-fu-add-mask-form-selection-below" "<Image>/Filters")
